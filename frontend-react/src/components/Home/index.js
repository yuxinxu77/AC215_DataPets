        ...
        <div className={classes.root}>
            <main className={classes.main}>
                <Container maxWidth="md" className={classes.container}>
                    ...
                    <center>Similar Dog Images Searched</center>
                    {prediction &&
                        <Typography variant="h4" gutterBottom align='center'>
                            {!prediction.poisonous &&
                                <span className={classes.safe}>{prediction['image_1'] }</span>
                            }
                            <div></div>
                            {!prediction.poisonous &&
                                <span className={classes.safe}>{prediction['image_2'] }</span>
                            }
                            <div></div>
                            {!prediction.poisonous &&
                                <span className={classes.safe}>{prediction['image_3'] }</span>
                            }
                            <div></div>
                            {!prediction.poisonous &&
                                <span className={classes.safe}>{prediction['image_4'] }</span>
                            }
                            <div></div>
                            {!prediction.poisonous &&
                                <span className={classes.safe}>{prediction['image_5'] }</span>
                            }
                        </Typography>
                    }
